...
data <- data %>% ungroup() %>% mutate(index.x = pnorm(z1.x - 0.64), index.y = pnorm(z1.y - 0.64), index.x.norm = pnorm(z1.x.norm- 0.64), index.y.norm = pnorm(z1.y.norm - 0.64), xmin = pnorm(z1.x - 0.64 - 1.96*se.z1.x), xmax = pnorm(z1.x - 0.64 + 1.96*se.z1.x), ymin = pnorm(z1.y - 0.64 - 1.96*se.z1.y), ymax = pnorm(z1.y - 0.64 + 1.96*se.z1.y))
